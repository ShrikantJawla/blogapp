    ...
    >
      {links.map((ele, ind) => (
        <>
          ...
          {ind === 3 && (
            <Text key={nanoid()} color={'white'} fontWeight="600" style={{ display: variant }}>
              |
            </Text>
          )}
        </>
      ))}
      {
        session ?
          ...
          <Link key={nanoid()} href={'/auth/login'} style={{ display: variant }}>
            <Text
              color="white"
              fontSize={17}
              fontWeight={600}
            ...
            <Link key={nanoid()} href={'/auth/signup'} style={{ display: variant }}>
            <Text
              color="white"
              fontSize={17}
              fontWeight={600}
